    ...
    <div class="box-header with-border">
        ...
        <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
            ...
            <div class="panel-body">
                <form action="{{route('jovem.index')}}"  method="post">
                    {{ csrf_field() }}
                    <div class="form-row">
...
<!--test -->
@foreach ($sobre as $teste)
 @if(auth()->user()->id == $teste->user_id)
   <ul>
     <li>
      <div>
       <div class="pull-right icons-align">
        <a href="" class="editInline"><i class="glyphicon glyphicon-plus"></i>
       </a>
        </div>
       <h4><i class="fa fa-check-square-o"></i> <span><a href="">
       </a>
     </span></h4>
    </div>
  </li>
