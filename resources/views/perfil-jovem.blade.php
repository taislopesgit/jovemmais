      ...
      <div class="box box-primary">
         <div class="box-body box-profile">
            ...
            <p class="text-muted text-center">
                <a href="{{route('editar', $usuario->id_jovem)}}"
                    class="text-blue"
                    title="editar"
                    data-toggle="tooltip"
                    data-placement="top">
            ...
            <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Nome</b>
                    <a class="pull-right">{{$usuario->nome}}</a>
                </li>
               <li class="list-group-item">
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                        <li class="active">
                            <a href="#calendario" data-toggle="tab" aria-expanded="true">
                                <i class="fa fa-calendar-check bg-dark"></i>&nbsp;&nbsp;Calendário
                            </a>
                        </li>
                        <li class="">
                            <a href="#treinamento" data-toggle="tab" aria-expanded="false">
                                <i class="fas fa-book"></i></i>&nbsp;&nbsp;Treinamento
                            </a>
                        </li>
                        <li class="">
                            <a href="#marcacao" data-toggle="tab" aria-expanded="false">
                                 <i class="fa fa-history bg-dark"></i>&nbsp;&nbsp;Marcação
                            </a>
                        </li>
                        <li class="">
                            <a href="#ocorrencia" data-toggle="tab" aria-expanded="false">
                                <i class="fas fa-exclamation-circle"></i></i>&nbsp;&nbsp;Ocorrência
                            </a>
                        </li>
                    ...
                    <div class="tab-pane" id="ocorrencia">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach($verOcorrenciaId as $ocorrenciaId)
                                    <tr>
                                        <td class="align-middle">{{$ocorrenciaId->id_ocorrencia}}</td>
                                        <td class="align-middle text-center">{{$ocorrenciaId->id_tipo_ocorrencia}}</td>
                                        <td class="align-middle text-center">{{$ocorrenciaId->descricao}}</td>
                                        <td class="align-middle text-center">{{$ocorrenciaId->responsavel}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            ...
                            @if (isset($ocorrenciaJovem))
                                {{ $verOcorrenciaId->appends($ocorrenciaJovem)->links() }}
                            @else
                                {{ $verOcorrenciaId->links() }}
                            @endif
                            </div>
                        </div>
                    </div>
